...
function onFunc()
{
	...
	$newpass2=$_POST["newpass2"];
		...
		$sql = "UPDATE user_data SET userpass=$newpass where userid='$email'";
		...
		{	
			...
			$_SESSION['result']="Enter a registered Email.";
		}
		else
		{
			$_SESSION['result']="New Passwords does not match.";
		}
	echo "<h3 class='col-md-offset-5'>".$_SESSION['result']."<h3>";
}
?>
<!--//login-->
</body>
